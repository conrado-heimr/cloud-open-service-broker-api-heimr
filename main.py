...
app.include_router(
    ...
    prefix=f"{settings.ROOT_PATH}/cloud-professional-services",
...
app.include_router(
    ...
    prefix=f"{settings.ROOT_PATH}/vmware-professional-services",
...
app.include_router(
    ...
    prefix=f"{settings.ROOT_PATH}/powervs-professional-services",
